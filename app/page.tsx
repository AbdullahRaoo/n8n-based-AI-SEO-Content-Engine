...
export default function SEOContentDashboard() {
  ...
  const handleSubmitUrl = async () => {
    ...
    try {
      ...
      // DUPLICATE CODE REMOVED - This was causing articles to be created twice
      // const newArticle = adaptContentToArticle(finalResult)

      // DUPLICATE DATABASE SAVE REMOVED - This was causing duplicate articles
      // const response = await fetch('/api/articles/create', {
      //   method: 'POST',
      //   headers: {
      //     'Content-Type': 'application/json',
      ...
      // DUPLICATE UI UPDATES REMOVED - Already handled in polling success branch
      // setProcessingProgress(100)
      // setProcessingStage("Complete!")
      //
      // // Refresh articles from database
      ...
      // DUPLICATE SUCCESS TOAST REMOVED - Already handled in polling success branch
      // toast({
      //   title: "Success!",
